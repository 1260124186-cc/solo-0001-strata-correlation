...
func New(service *catalog.Service, logger *slog.Logger) http.Handler {
	...
	mux.HandleFunc("GET /api/v1/comparison-algorithms", h.comparisonAlgorithms)
	...
	mux.HandleFunc("GET /api/v1/comparisons/{id}/algorithm-diff", h.comparisonDiff)
	mux.HandleFunc("POST /api/v1/comparisons/{id}/recompute", h.recompute)
