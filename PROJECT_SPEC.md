...
最旧的一段连续历史版本可归档：归档版本退出常规历史列表，但仍按原版本号读取；版本号与位置无关，归档不重排编号，已保存的对比与引用不受影响；最新版本不可归档。
...
## 容量与运行边界
最多 2000 个剖面、每个剖面 500 个未归档版本、10000 个对比结果，持久化快照最多 64 MiB。当前基线适用于 Linux/macOS 单进程本机服务，无外部依赖、无前端、无数据删除和多节点复制。正式测试套件由后续专项测试任务添加。
